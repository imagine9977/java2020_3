...
public class Image {
	private int ino;	//?ù¥ÎØ∏Ï?ÏΩîÎìú
	private String name;	//?ù¥ÎØ∏Ï? ?ù¥Î¶?
	private String url;		//?ù¥ÎØ∏Ï? Í≤ΩÎ°ú
	private int volume;		//?ù¥ÎØ∏Ï? ?ö©?üâ
	private int hori;	//Í∞?Î°? ?Å¨Í∏?
	private int verti;	//?Ñ∏Î°? ?Å¨Í∏?
	public Image() { }
